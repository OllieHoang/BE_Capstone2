    ...
    onSubmit: async () => {
      ...
      bcrypt.compare(oldpass, oldPass, async (err, result) => {
        ...
        if (result) {
          try {
            await authApi
              .resetPassword({ token: token, password: newpass })
              .then(() => {
    ...
    <form onSubmit={formik.handleSubmit}>
      <div className={`form-group ${styles.formGroup}`}>
        ...
        {formik.errors.oldpass && formik.touched.oldpass ? (
          <p className="text-red-400 text-[13px] pl-[150px] pt-[5px]">
      ...
      <button
        ...
        disabled={
          formik.errors.oldpass || formik.errors.newpass || formik.errors.cfpass
        }
      >
        Update
      </button>
